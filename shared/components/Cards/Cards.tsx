...
const Cards: React.FC<StatusCardProps> = ({
  ...
  if (version === "image-row") {
    return (
      ...
      >
        ...
        <Container className={`w-1/2 flex flex-col justify-center px-2 ${bgColor}`}>
  ...
  return (
    <Container
      ...
      } ${direction === "vertical" ? "flex-col py-[8px]" : "flex py-7"} border-b-2 ${borderColor}`}
    ...
    >
      ...
      <Container className={direction === "horizontal" ? "text-start" : "text-center mt-2"}>
