...
const controls: {
  [K in keyof Omit<
    CurrencyInputProps,
    "language"
  >]?: ControlDefinition<CurrencyInputProps>;
} & {
  fieldKey?: ControlDefinition<CurrencyInputProps>;
  propsOverride?: ControlDefinition<CurrencyInputProps>;
} = {
  fieldKey: {
    type: ["text"],
    label: "Field Key",
  ...
  label: {
    ...
    defaultValueAr: "Currency",
    defaultCode: "return 'Currency'",
    defaultCodeAr: "return 'Currency'",
  },
  placeholder: {
    type: ["text", "code"],
    label: "Placeholder",
  ...
  currencySymbol: {
    ...
    options: ["AED", "USD", "EUR", "GBP", "SAR", "QAR", "OMR", "KWD", "BHD"],
    defaultValue: "AED",
    defaultCode: "return 'AED'",
  },
  onChange: {
    type: ["code"],
    label: "onChange",
