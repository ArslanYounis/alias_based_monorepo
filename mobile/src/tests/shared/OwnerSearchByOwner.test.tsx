/**
 * Tests for the shared OwnerSearchByOwner component.
 * Covers: form field rendering, search button, drawer interaction,
 * platform variants, Arabic language, pending state.
 */
...
describe("OwnerSearchByOwner", () => {
  ...
  it("renders without crashing", () => {
    render(<OwnerSearchByOwner language="en" />);
  });
  ...
  it("renders Arabic search button when language=ar", () => {
    render(<OwnerSearchByOwner language="ar" />);
    expect(screen.getByTestId("btn-Search")).toBeTruthy();
  });

  it("renders in mobile platform", () => {
    render(<OwnerSearchByOwner language="en" platform="mobile" />);
    expect(screen.getByTestId("btn-Search")).toBeTruthy();
  });
