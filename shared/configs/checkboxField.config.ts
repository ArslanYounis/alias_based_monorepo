...
const controls: {
  [K in keyof Omit<
    CheckboxFieldProps,
    "language"
  >]?: ControlDefinition<CheckboxFieldProps>;
} & {
  fieldKey?: ControlDefinition<CheckboxFieldProps>;
  propsOverride?: ControlDefinition<CheckboxFieldProps>;
} = {
  fieldKey: {
    type: ["text"],
    label: "Field Key",
  ...
  label: {
    ...
    defaultValueAr: "CheckboxField",
    defaultCode: "return 'CheckboxField'",
    defaultCodeAr: "return 'CheckboxField'",
  },
  disabled: {
    type: ["boolean", "code"],
    label: "Disabled?",
