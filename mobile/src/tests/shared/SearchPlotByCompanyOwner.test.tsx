/**
 * Tests for the shared ByCompanyOwner search form component.
 * Covers: rendering company fields, search button, drawer, platform variants.
 */
...
jest.mock("@shared/components/SearchPlot/constants", () => ({
  ...
  CompanyOwnerDefaultValues: { companyName: "", certificateNumber: "", matchType: "", resultsDisplay: "", tradeLicense: "" },
...
describe("ByCompanyOwner", () => {
  afterEach(() => jest.clearAllMocks());

  it("renders without crashing", () => {
    render(<ByCompanyOwner language="en" />);
  });
  ...
  it("renders Arabic search button when language=ar", () => {
    render(<ByCompanyOwner language="ar" />);
    expect(screen.getByTestId("btn-Search")).toBeTruthy();
  });

  it("renders in mobile platform", () => {
    render(<ByCompanyOwner language="en" platform="mobile" />);
    expect(screen.getByTestId("btn-Search")).toBeTruthy();
  });
