...
const controls: {
...
} & { fieldKey?: ControlDefinition<SelectProps>; bindingData?: ControlDefinition<SelectProps>; propsOverride?: ControlDefinition<SelectProps> } = {
  fieldKey: { type: ["text"], label: "Field Key", hasArabic: false, isRequired: true, unique: true, defaultValue: "" },
  label: { type: ["text", "code"], label: "Label", hasArabic: true, defaultValue: "Select", defaultValueAr: "Select", defaultCode: "return 'Select'", defaultCodeAr: "return 'Select'" },
  ...
  onChange: { type: ["code"], label: "onChange", defaultCode: 'console.log("input changes", eventData)', isEvent: true, visibility: (props: SelectProps) => !props.disabled },
