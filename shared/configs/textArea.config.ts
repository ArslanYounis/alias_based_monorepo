...
const controls: {
  [K in keyof Omit<TextAreaProps, "language">]?: ControlDefinition<TextAreaProps>;
} & { fieldKey?: ControlDefinition<TextAreaProps>; propsOverride?: ControlDefinition<TextAreaProps> } = {
  fieldKey: {
    type: ["text"],
    label: "Field Key",
    hasArabic: false,
  ...
  label: { type: ["text", "code"], label: "Label", hasArabic: true, defaultValue: "TextArea", defaultValueAr: "TextArea", defaultCode: "return 'TextArea'", defaultCodeAr: "return 'TextArea'" },
  ...
  onChange: { type: ["code"], label: "onChange", defaultCode: 'console.log("input changes", eventData)', isEvent: true, visibility: (props: TextAreaProps) => !props.disabled },
