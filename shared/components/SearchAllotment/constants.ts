...
export const SearchByCompanyOwnerOptionalFields = [
    { id: "tradeLicense", label: "Trade License", label_ar: "رخصة تجارية", value: "tradeLicense", value_ar: "tradeLicense" },
    {
        id: "westernRegionArchiveNo",
        label: "Western Region Archive No",
        label_ar: "رقم أرشيف المنطقة الغربية",
    ...
    { id: "alAinArchiveNo", label: "Al Ain Archive No", label_ar: "رقم أرشيف العين", value: "alAinArchiveNo", value_ar: "alAinArchiveNo" },
];
