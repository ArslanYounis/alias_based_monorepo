...
const controls: {
  [K in keyof Omit<
    NumberInputProps,
    "language"
  >]?: ControlDefinition<NumberInputProps>;
} & {
  fieldKey?: ControlDefinition<NumberInputProps>;
  propsOverride?: ControlDefinition<NumberInputProps>;
} = {
  fieldKey: {
    type: ["text"],
    label: "Field Key",
  ...
  label: {
    ...
    hasArabic: true,
    defaultValue: "Number",
    defaultValueAr: "Number",
    defaultCode: "return 'Number'",
    defaultCodeAr: "return 'Number'",
  },
  placeholder: {
    type: ["text", "code"],
    label: "Placeholder",
