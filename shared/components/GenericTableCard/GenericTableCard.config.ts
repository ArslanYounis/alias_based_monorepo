...
import GenericTableCard, {
  type IGenericTableCardProps,
} from "./GenericTableCard";

const GenericTableCardConfig: ComponentConfig<IGenericTableCardProps> = {
  id: "genericTableCard",
  icon: CreditCardIcon,
...
export default GenericTableCardConfig;
